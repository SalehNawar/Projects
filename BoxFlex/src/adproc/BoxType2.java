...
public class BoxType2 extends Box      
{
    ...
    */
    public BoxType2(double width, double length, double height, int grade,int quantity, boolean seltop)
    {
    ...
    */
    public double price()
    {
        ...
        double colour = calcolour( price , 1);
    ...
    */
    ...
    {
     return "Type 2 Box - " + " Width: " + width+ ", Height: " + height + ", Length: " + length + ", Quantity: " + quantity + "\n"; 
    }
