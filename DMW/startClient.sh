######This Script sets up our Workers######
#Author: Saleh Nawar
#UP918156
...
server=`(curl "http://metadata.google.internal/computeMetadata/v1/instance/attributes/server" -H "Metadata-Flavor: Google")`

#run client 
npm run client $key $server 
echo "***********Workers Done***********"

#stop workers after completing tasks
sudo poweroff
